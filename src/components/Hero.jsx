    ...
    <section className='relative w-full lg:h-screen h-[60vh] '>
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            A Developer Based in India<br className='sm:block hidden' /> I love building tools that are user-friendly, efficient, and innovative.
          </p>
        </div>
      </div>
      ...
      <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2">
        <img
          src="/hero.png"
          alt="hero"
          className="md:w-[500px] w-[700px] h-auto object-contain" // Adjust size as needed
        />
      </div>
